...
<script>
// LINE CHART - Consumo real dos últimos 7 dias vindo do banco
new Chart(document.getElementById("lineChart"), {
  ...
  data: {
    ...
    datasets: [{
      label: "Consumo (L)",
      data: @json($dadosGraficoLinha), // Injeta o array do PHP de forma segura no JavaScript
      borderColor: "#010102",
